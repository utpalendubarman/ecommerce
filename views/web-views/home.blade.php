...
@php($business_mode=\App\CPU\Helpers::get_business_settings('business_mode'))
        ...
        <div class="row">
            @if ($business_mode == 'multi')
                <div class="col-md-6 {{Session::get('direction') === "rtl" ? 'pr-0' : 'pl-0'}}">
                    <div class="card" style="min-height: 380px;background-color:#ffffff00 !important;border:0px #ffffff00 !important">
                        <div class="card-body">
                                ...
                                @foreach($categories as $key=>$category)
                                    ...
                                    <div class=""  style="margin: 5px;">
                                        <a href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}">
                                            <img style="vertical-align: middle; height: 70px !important;border-radius: 5px;"
            ...
            @else
                <div class="col-md-12 pl-0 pr-0">
                    <div class="card" style="min-height: 232px;background-color:#ffffff00 !important;border:0px #ffffff00 !important">
                        <div class="card-body">
                            <div class="row d-flex justify-content-between">
                                ...
                                @foreach($categories as $key=>$category)
                                    @if ($key<11)
                                        <div class="text-center"  style="margin: 5px;">
                                            <a href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}">
                                                <img style="vertical-align: middle; height: 60px;border-radius: 5px;"
                                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                    src="{{asset("storage/app/public/category/$category->icon")}}"
                                                    alt="{{$category->name}}">
                                                <p class="text-center small "
    ...
    <div class="container mb-4">
        <div class="row" style="background: white;box-shadow: 0px 3px 6px #0000000d;border-radius: 5px;">
            ...
            <div class="col-md-12">
                <div class="feature-product" style="padding-left:40px;padding-right: 40px;padding-top: 10px;">
                            ...
                            <div class="recomanded-product-card">
                                ...
                                <div style="background:#ffffff;margin:20px;padding-top: 10px;height: 200px;border-radius: 0px 0px 5px 5px;">
                                    <div style="text-align: left; padding: 20px;">
                                        ...
                                        @php($overallRating = strval(mt_rand (4*10, 5*10) / 10))
                                        <div class="rating-show" style="height:125px; ">
                                            <h5 style="font-weight: 600; color: {{$web_config['primary_color']}}">
                                            ...
                                            <span class="d-inline-block font-size-sm text-body">
                                                @for($inc=0;$inc<5;$inc++)
                                                    ...
                                                    @endif
                                                @endfor
                                                <label class="badge-style">( {{strval(rand(88,100))}} )</label>
                                            </span>
                                        </div>
                                        <div class="float-right">
    ...
    <!--<div class="container rtl mt-3">
        <div class="row d-flex justify-content-center">
            <div style="margin-top:24px;font-weight: 700;font-size: 26px;">
                <p style="float: right">New Arrivals</p>
            </div>
        </div>
    </div>
                                                    ...
                                                    <span class="d-inline-block font-size-sm text-body">
                                                        @for($inc=0;$inc<5;$inc++)
                                                            @if($inc<$top_overallRating[0])
                                                                <i class="sr-star czi-star-filled active"></i>
                                                            @else
                                                                <i class="sr-star sr-star czi-star-filled active" style="color:#fea569 !important"></i>
                                                            @endif
                                                        @endfor
